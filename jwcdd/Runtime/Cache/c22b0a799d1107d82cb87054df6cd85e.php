...
<div class='span4 pull-right'>
    <div class='row-fluid'>
        <strong>学年学期</strong>
        <form id="form1" method="post" action="<?php echo U('Analysis/month');?>">
...
<div class='row-fluid'>
    <div class='span12 box bordered-box green-border' style='margin-bottom:0;'>
        <div class='box-header green-background'>
            <div class='text-center'><?php echo ($title); ?>&nbsp;&nbsp;督导听课统计总表（按院系、月份统计）</div>
                ...
                <table class='table table-bordered table-hover table-striped' style='margin-bottom:0;' id="table1">
                  <thead>
                    ...
                    <tr>
                        ...
                        <th rowspan='2'>听课月份</th>
                        <th colspan='7'>总计</th>
                        <th colspan='7'>其中课程类别1:绪论课</th>
                        <th colspan='7'>其中课程类别2:双语课</th>
                        <th colspan='7'>其中课程类别3:实验课</th>
                    </tr>
                    <tr>
                        <th>总计</th>
                        <th>好</th>
                  ...
                  <tbody>
                    <?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                        ...
                        <td><?php echo ($vo["xlk_zj"]); ?></td>
                        <td><?php echo ($vo["xlk_h"]); ?></td>
                        <td><?php echo ($vo["xlk_j"]); ?></td>
                        <td><?php echo ($vo["xlk_yb"]); ?></td>
                        <td><?php echo ($vo["xlk_jc"]); ?></td>
                        <td><?php echo ($vo["xlk_c"]); ?></td>
                        <td><?php echo ($vo["xlk_k"]); ?></td>
                        <td><?php echo ($vo["syk_zj"]); ?></td>
                        <td><?php echo ($vo["syk_h"]); ?></td>
                        <td><?php echo ($vo["syk_j"]); ?></td>
                        <td><?php echo ($vo["syk_yb"]); ?></td>
                        <td><?php echo ($vo["syk_jc"]); ?></td>
                        <td><?php echo ($vo["syk_c"]); ?></td>
                        <td><?php echo ($vo["syk_k"]); ?></td>
                        <td><?php echo ($vo["exk_zj"]); ?></td>
                        <td><?php echo ($vo["exk_h"]); ?></td>
                        <td><?php echo ($vo["exk_j"]); ?></td>
                        <td><?php echo ($vo["exk_yb"]); ?></td>
                        <td><?php echo ($vo["exk_jc"]); ?></td>
                        <td><?php echo ($vo["exk_c"]); ?></td>
                        <td><?php echo ($vo["exk_k"]); ?></td>
...
<script type="text/javascript">
    $(document).ready(function(){
        $('#smanager').nav_slide('smanager','month');
