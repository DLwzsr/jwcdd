...
<section id='content'>
    ...
    <div class='row-fluid'>
        ...
        <div class='span6 row-fluid pull-right' style="margin-top:38px;">
            <div class='span4'>
                <div class='row-fluid'>
                    <strong>选择教师</strong>
            ...
            <div class='responsive-table'>
                <div class='scrollable-area'>
                    <table class='table table-bordered table-hover table-striped' style='margin-bottom:0;'>
                            ...
                            <td colspan="9">
                                <div class="form-group">
                                    ...
                                    <label class="radio inline">
                                        <input id='' type='radio' value='' name='pingjia' />&nbsp;&nbsp;好
                                    </label>
                                    <label class="radio inline">
                                        <input id='' type='radio' value='' name='pingjia' />&nbsp;&nbsp;较好
                                    </label>
                                    <label class="radio inline">
                                        <input id='' type='radio' value='' name='pingjia' />&nbsp;&nbsp;一般
                                    </label>
                                    <label class="radio inline">
                                        <input id='' type='radio' value='' name='pingjia' />&nbsp;&nbsp;较差
                                    </label>
                                    <label class="radio inline">
                                        <input id='' type='radio' value='' name='pingjia' />&nbsp;&nbsp;差
                                    </label>
                                    <label class="radio inline">
                                        <input id='' type='radio' value='' name='pingjia' checked/>&nbsp;&nbsp;未评价
                                    </label>
                                </div>
                            </td>
                        </tr> 
                        ...
                        <tr>
                            <td colspan="10">说明：</br>1.本表只是听课的实况记录，仅作为教师教学情况评价的参考，不作为或决定对一门课程的全面评价。</br>2.对每一个考察点进行评价，请在好、较好、一般、较差、差五个等级中选择，并选中相应位置。</td>
                        </tr>   
                        <tr>
                            <th>听课专家（签字）</th>
                            <td colspan="2">
