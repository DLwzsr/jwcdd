...
<div class='box-header green-background'>
    <div class='text-center'>2014-2015 第 1 学期听课任务列表</div>
</div>
...
<tr>
    ...
    <td>
        <div class='text-right'>
            <a class='btn btn-success btn-mini' data-toggle='modal' href='#modal-example2' role='button'>
                <i class='icon-edit'></i>
            </a>
    ...
    <div class='modal-body'>
        <form class='form form-horizontal' style='margin-bottom: 0;' />
            <div class='control-group'>
                <label class='control-label'>听课日期</label>
                <div class='controls'>
                    <div class='datepicker input-append' id='datepicker'>
                        <input class='input-medium' data-format='yyyy-MM-dd' placeholder='选择日期' type='text' />
                        <span class='add-on'>
